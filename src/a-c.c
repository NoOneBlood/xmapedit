...
void vlineasm4(int cnt, void *p)
{
    int i; unsigned char ch, *pp = (unsigned char *)p;
	const unsigned char *pal[4] = {
		(unsigned char *)palookupoffse[0],
		(unsigned char *)palookupoffse[1],
		(unsigned char *)palookupoffse[2],
		(unsigned char *)palookupoffse[3],
	};
    
	const unsigned char *buf[4] = {
		(unsigned char *)bufplce[0], 
		(unsigned char *)bufplce[1], 
		(unsigned char *)bufplce[2], 
		(unsigned char *)bufplce[3],
	};
...
void mvlineasm4(int cnt, void *p)
{
    int i; unsigned char ch, *pp = (unsigned char *)p;
	const unsigned char *pal[4] = {
		(unsigned char *)palookupoffse[0],
